...
public class FirstTest {
    ...
    public void testCloseSearch() {
        ...
        waitForElementNotPresent(
                By.id("org.wikipedia:id/search_close_btn"),
                "'Cancel' is still present on the page",
                5
        );
    }
    ...
    public void testCompareInputSearchText() {
        ...
        WebElement input_search = waitForElementPresent(
                By.id("org.wikipedia:id/search_src_text"),
                "Cannot find article title",
                15
        );
    ...
    public void testSwipeArticle() {
        ...
        waitForElementAndClick(
                ...
                "Cannot find 'Appium' article to search",
                15
        );
    ...
    public void testSaveArticleToMyList(){
        ...
        waitForElementNotPresent(
                By.xpath("//org.wikipedia:id/page_list_item_container[@text='Java (programming language)']"),
    ...
    public void testSaveTwoArticles(){
        ...
        WebElement title_before = waitForElementPresent(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot find article title",
                15
        );
        ...
        WebElement title_after = waitForElementPresent(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot find article title",
                15
        );
    ...
    private void assertElementPresent(By by, String error_message){
        int amount_of_elements = getAmountOfElements(by);
        if (amount_of_elements == 0){
            String default_message = "Element '" + by.toString() + "' supposed present.";
            throw new AssertionError(default_message + " " + error_message);
        }
    }
}
